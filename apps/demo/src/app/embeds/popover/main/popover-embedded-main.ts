...
@Component({
  selector: 'popover-embedded-main',
  standalone: true,
  animations: [fadeIn],
  imports: [CommonModule, PopoverComponent, PopoverButtonComponent, PopoverPanelComponent],
  templateUrl: './popover-embedded-main.html',
})
export class PopoverEmbeddedMainComponent {
