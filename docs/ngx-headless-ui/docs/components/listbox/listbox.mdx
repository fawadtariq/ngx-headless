...
preview="/embeds/listbox/main" language="html"
  code={`<Listbox #listbox="ngxListbox" class="relative w-72">
  <ListboxButton
  ...
  <ListboxOptions *ngIf="listbox.isOpen()" @slideDown
    ...
    <ListboxOption *ngFor="let person of people" [value]="person"
      ...
      <span *ngIf="person === selectedPerson" class="absolute inset-y-0 left-0 flex items-center pl-3 text-amber-600">
...
- [Headless UI - Listbox](https://headlessui.com/vue/listbox)
